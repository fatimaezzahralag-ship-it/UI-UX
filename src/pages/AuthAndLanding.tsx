...
import { ArrowRight, Zap, Calendar, Users, Layers } from 'lucide-react';
    ...
    <div className="min-h-screen bg-ink-950 text-white">
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-ink-800">
        <div className="flex items-center">
          <img src={unismartLogo} alt="UniSmart" className="h-10 w-auto object-contain" />
        </div>
    ...
    <div className="min-h-screen bg-ink-50 flex items-center justify-center p-6">
      <div className="card w-full max-w-sm p-0 overflow-hidden">
        <div className="bg-ink-950 p-6 text-center">
          <img src={unismartLogo} alt="UniSmart" className="h-12 w-auto object-contain mx-auto mb-3" />
